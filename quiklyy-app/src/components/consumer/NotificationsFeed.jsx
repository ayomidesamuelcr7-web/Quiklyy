...
export default function NotificationsFeed() {
  ...
  return (
    <div className="bg-white min-h-[calc(100vh-80px)] text-gray-900 font-sans pb-12 animate-slide-up relative">
      ...
      {/* Header Navigation */}
      <div className="flex items-center justify-between px-0.5 py-6 border-b border-gray-100">
      ...
      <div className="max-w-lg mx-auto w-full">
        {NOTIFICATIONS.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-0.5 text-center">
