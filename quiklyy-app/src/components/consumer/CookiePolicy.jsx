...
export default function CookiePolicy() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans animate-slide-up relative flex flex-col">
      ...
      {/* Header Navigation */}
      <div className="sticky top-0 bg-white/80 backdrop-blur-md z-10 flex items-center px-2 py-6 border-b border-gray-100 shrink-0">
        <button 
          onClick={() => navigate(-1)} 
      ...
      <div className="px-2 py-8 max-w-2xl mx-auto w-full flex-1">
