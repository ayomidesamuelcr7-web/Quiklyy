...
export default function LegalDetails() {
  ...
  return (
    <div className="bg-white min-h-[calc(100vh-80px)] text-gray-900 font-sans pb-12 animate-slide-up relative flex flex-col">
      ...
      {/* Header Navigation */}
      <div className="flex items-center px-2 py-6 border-b border-gray-100 shrink-0">
        <button 
          onClick={() => navigate(-1)} 
      ...
      <div className="px-2 py-8 space-y-8 max-w-lg mx-auto w-full flex-1 flex flex-col">
